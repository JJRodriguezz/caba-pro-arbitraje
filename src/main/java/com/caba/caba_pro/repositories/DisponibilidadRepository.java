/**
 * Archivo: DisponibilidadRepository.java Autores: Diego.Gonzalez Fecha última modificación:
 * [10.09.2025] Descripción: Repositorio para la gestión de disponibilidad de árbitros Proyecto:
